...
class TableLineEntity(Base):
    ...
    tableSide: Mapped[str] = mapped_column(String(30))
    room_id: Mapped[int] = mapped_column(ForeignKey("room.id"))
    room: Mapped[RoomEntity] = relationship(lazy="joined")

    def __init__(self,project_id,id,name, x, y,width,reelX,reelY,orientation,room_id,tableSide):
