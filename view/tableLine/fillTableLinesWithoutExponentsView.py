...
class FillTableLinesWithoutExponentsView(QWidget):
    ...
    def __init__(self,store,appController,tableController):
        ...
        label = QLabel("Remplir lignes de tables")   
        layout = QFormLayout()
    ...
    def fillTables(self):
        self.tableController.fillTableLinesWithoutExponents(self.selectedRoom)